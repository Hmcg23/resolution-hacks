# Partner Lens — pitch guide

Straightforward outline for judges or investors: what we are, why we exist, how the app is organized, and how to demo it.
...
**Partner Lens helps partners understand two bodies in one relationship—using simple visuals and plain language, not pink diaries or mystery.**

---

## 3. Why we’re different (vs Flo / Clue)

| | Typical trackers (Flo, Clue) | Partner Lens |
|---|------------------------------|--------------|
| **Primary user** | Women tracking for themselves | Partners (often men) learning *with* their partner |
| **Feel** | Diary, calendar, articles | Dark, data-forward, “stats HUD” for biology |
| **Job** | Personal tracking, fertility | **Empathy + shared decisions**, not logging her period for her |

If asked *“Why not just read a website?”* — **Because the app pairs education with a shared frame:** same cycle day drives the dashboard and the playbook so the story stays coherent in one tap.
...
## 6. Boundaries (say these if challenged)

- **Not medical advice** — models and public-health-style effectiveness ranges; always defer to a clinician for personal decisions.
- **Not surveillance** — demo uses a **manual cycle day**; we’re not building stealth tracking.
- **Not therapy** — supportive tone, not mental-health treatment.

---

## 7. Optional Q&A prep

- **Privacy / data:** Demo is local state; no account required for the hackathon build.
- **Who is it for?** Partners who want to learn; still useful for couples together.
- **Monetization (if asked):** B2B (campus wellness, telehealth education bundles)—not the focus of v1.

---

## 8. Checklist before you present
